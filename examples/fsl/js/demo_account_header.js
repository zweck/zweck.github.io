...
require([
	...
	'molecules/account_header'
],
	
function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, account_header) {

	console.log('[account_header.js] Demo init');
	// Run elementQuery
	eq.init();
