...
require([
	...
	'molecule/software_download_promo'
],

function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, software_download_promo) {

	console.log('[software_download_promo.js] Demo init');
	// Run elementQuery
	eq.init();
