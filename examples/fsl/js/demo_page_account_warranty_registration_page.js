...
require([
	...
	'molecule/page_account_warranty_registration_page'
],

function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, page_account_warranty_registration_page) {

	console.log('[page_account_warranty_registration_page.js] Demo init');
	// Run elementQuery
	eq.init();
