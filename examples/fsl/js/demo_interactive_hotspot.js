...
require([
	...
	'atoms/_interactive_hotspot'
],
	
function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, interactive_hotspot) {

	console.log('[interactive_hotspot.js] Demo init');
	// Run elementQuery
	eq.init();
