...
require([
	...
	'molecule/account_header_edit'
],

function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, account_header_edit) {

	console.log('[account_header_edit.js] Demo init');
	// Run elementQuery
	eq.init();
