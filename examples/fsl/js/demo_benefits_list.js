 ...
 * @author [Kevin Coyle kevin.coyle@drutek.co.uk
 */
...
require([
	...
	'molecule/benefits_list'
],

function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, benefits_list) {

	console.log('[benefits_list.js] Demo init');
	// Run elementQuery
	eq.init();
