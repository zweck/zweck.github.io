...
require([
	...
	'molecules/product_references'
],
	
function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, product_references) {

	console.log('[product_references.js] Demo init');
	// Run elementQuery
	eq.init();
