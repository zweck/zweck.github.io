...
require([
	...
	'atom/event_details_map'
],

function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, event_details_map) {

	console.log('[event_details_map.js] Demo init');
	// Run elementQuery
	eq.init();
