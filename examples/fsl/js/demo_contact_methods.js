 ...
 * @author Brian Simpson brian.simpson@kp360.com
 */
...
require([
	...
	'molecules/contact_methods'
],
	
function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, contact_methods) {

	console.log('[contact_methods.js] Demo init');
	// Run elementQuery
	eq.init();
