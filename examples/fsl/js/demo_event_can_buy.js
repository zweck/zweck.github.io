...
require([
	...
	'molecules/event_can_buy'
],
	
function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, event_can_buy) {

	console.log('[event_can_buy.js] Demo init');
	// Run elementQuery
	eq.init();
