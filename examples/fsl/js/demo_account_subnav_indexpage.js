...
require([
	...
	'molecule/account_subnav_indexpage'
],

function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, account_subnav_indexpage) {

	console.log('[account_subnav_indexpage.js] Demo init');
	// Run elementQuery
	eq.init();
