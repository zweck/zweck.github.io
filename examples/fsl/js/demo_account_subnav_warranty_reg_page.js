...
require([
	...
	'molecule/account_subnav_warranty_reg_page'
],

function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, account_subnav_warranty_reg_page) {

	console.log('[account_subnav_warranty_reg_page.js] Demo init');
	// Run elementQuery
	eq.init();
