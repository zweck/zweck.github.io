...
require([
	...
	'molecule/account_subnav_addresspage'
],

function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, account_subnav_addresspage) {

	console.log('[account_subnav_addresspage.js] Demo init');
	// Run elementQuery
	eq.init();
