...
require([
	...
	'molecule/account_subnav_orderpage'
],

function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, account_subnav_orderpage) {

	console.log('[account_subnav_orderpage.js] Demo init');
	// Run elementQuery
	eq.init();
