...
require([
	...
	'organisms/software_download'
],
	
function (consolePolyfill, $, eq, OffCanvas, viewportSetter, Modernizr, MP, icomoonLiga, software_download) {

	console.log('[software_download.js] Demo init');
	// Run elementQuery
	eq.init();
