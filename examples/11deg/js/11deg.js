...
j.start&&j.start(a)):void 0==a.data("flexslider")&&new d.flexslider(this,j)});var l=d(this).data("flexslider");switch(j){case "play":l.play();break;case "pause":l.pause();break;case "next":l.flexAnimate(l.getTarget("next"),!0);break;case "prev":case "previous":l.flexAnimate(l.getTarget("prev"),!0);break;default:"number"===typeof j&&l.flexAnimate(j,!0)}}})(jQuery);;$(document).ready(function($) {

    $("#support_us .img-container .video").fitVids();
	...
	$('.twitter').on('mouseenter', function(){
		$('#enquire').css('backgroundColor', '#00ACED');
		$('#enquire a:not(.twitter)').css('visibility', 'hidden');
	});

	$('#enquire a').on('mouseleave', function(){
		$('#enquire').css('backgroundColor', '#ffffff');
		$('#enquire a').css('visibility', 'visible');
	});

	$('.tumblr').on('mouseenter', function(){
		$('#enquire').css('backgroundColor', '#2C4762');
		$('#enquire a:not(.tumblr)').css('visibility', 'hidden');
	});

	$('.email').on('mouseenter', function(){
		$('#enquire').css('backgroundColor', '#95AFCF');
		$('#enquire a:not(.email)').css('visibility', 'hidden');
	});
...
$(window).resize(checkButton);


function reveal(event) {

		var whiteTop = $('.white-section').position().top - $(window).scrollTop();
		var $crop = $('.crop');
		var $logoSwitch = $('.logo-switch');

		if( $crop.height() > $logoSwitch.height() + 10 ){
			$crop.height($logoSwitch.height())
		} else {
			$crop.css('height', whiteTop);
		}

		if(whiteTop <= 0){ 
			$logoSwitch.addClass('fix');
		} else {
			$logoSwitch.removeClass('fix');
		}

}

function checkButton(){
	var $enquireButton = $('.enquire .button-custom');

	if ($enquireButton.offset().top > $('.content-container .white-section').offset().top){
		$enquireButton.css('border-color', '#000');
		$enquireButton.css('color', '#000');
	} else {
		$enquireButton.css('border-color', '#fff');
		$enquireButton.css('color', '#fff');		
	}
}
 ...
 $('.what-button').on('click', function(e){
 	e.preventDefault()
        $("html, body").animate({ scrollTop: $('.content-container .white-section').offset().top }, 600);
        return false;
 });
 ...
 $('.design-button').on('click', function(e){
 	e.preventDefault()
        $("html, body").animate({ scrollTop: $('#design h3').offset().top + parseInt($('#design h3').css('padding-top')) }, 600);
        return false;
 });
 ...
 $('.support-button').on('click', function(e){
 	e.preventDefault()
        $("html, body").animate({ scrollTop: $('#support_us h3').offset().top + parseInt($('#support_us h3').css('padding-top')) }, 600);
        return false;
 });
